...
GPU_ID=${GPU_ID:-3}
OUT_NAME=e10_analytic_local_frame_residual_t4_s42
...
"${PY}" sua_exploration/scripts/train_variant_dandi688.py \
  ...
  --analytic_residual_e08_result sua_exploration/results/e08_analytic_only_t4_seed42.json \
  --analytic_residual_frame local \
  --analytic_residual_e09_result sua_exploration/results/p3_e09_analytic_direct_residual_t4_s42_seed42.json \
  --analytic_local_frame_epsilon 1e-6 \
