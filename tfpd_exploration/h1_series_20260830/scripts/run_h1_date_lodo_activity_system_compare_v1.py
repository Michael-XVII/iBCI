#!/usr/bin/env python3
"""Dry-by-default CLI for the H1 H-S/H-C activity comparison."""
...
from h1_date_lodo_activity_system_compare_v1.plan import dry_plan
...
def main() -> int:
    ...
    from h1_date_lodo_activity_system_compare_v1.evaluate import run, write_once
